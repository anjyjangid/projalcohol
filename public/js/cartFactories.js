...
function alcoholCartItem ($rootScope, $log, $filter) {
...
function alcoholCartLoyaltyItem ($log,$filter){
...
function alcoholCartPackage ($rootScope, $log){
...
function alcoholCartCreditCard (){
...
function alcoholCartGift($log, giftProduct){
...
function giftProduct ($rootScope, $q, $http, $log){
...
function alcoholCartPromotion ($log,$filter){
